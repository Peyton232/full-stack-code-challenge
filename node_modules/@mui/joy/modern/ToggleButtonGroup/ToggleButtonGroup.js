...
const ToggleButtonGroupRoot = styled(StyledButtonGroup, {
  ...
  '& [aria-pressed="true"], & [aria-pressed="true"]:not([data-first-child]):not([data-last-child])': _extends({}, ownerState.color !== 'context' && _extends({
    backgroundColor: theme.vars.palette?.[ownerState.color]?.[`${ownerState.variant}ActiveBg`]
  }, ownerState.variant === 'outlined' && {
    borderColor: theme.vars.palette?.[ownerState.color]?.[`${ownerState.variant}HoverBorder`]
  }, {
    '&:hover': {
      backgroundColor: theme.vars.palette?.[ownerState.color]?.[`${ownerState.variant}ActiveBg`]
    },
