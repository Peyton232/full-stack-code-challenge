...
export const StyledListItemButton = styled('div')(({
  ...
  return [_extends({}, ownerState.selected && {
  ...
  }), _extends({}, (_theme$variants2 = theme.variants[ownerState.variant]) == null ? void 0 : _theme$variants2[ownerState.color], !ownerState.selected && {
    ...
    [`&.${listItemButtonClasses.disabled}`]: (_theme$variants5 = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _theme$variants5[ownerState.color]
  }];
});
