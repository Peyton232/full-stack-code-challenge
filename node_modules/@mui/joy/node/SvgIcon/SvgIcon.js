...
const SvgIconRoot = (0, _styled.default)('svg', {
  ...
  return (0, _extends2.default)({}, ownerState.instanceFontSize && ownerState.instanceFontSize !== 'inherit' && {
    ...
    color: (_theme$variants$plain = theme.variants.plain) == null || (_theme$variants$plain = _theme$variants$plain[ownerState.color]) == null ? void 0 : _theme$variants$plain.color
  });
});
/**
 *
