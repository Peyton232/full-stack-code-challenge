...
const StyledInputStartDecorator = (0, _styles.styled)('div')(({
  ...
  var _theme$variants4, _theme$variants5;
  return (0, _extends2.default)({
    ...
    color: (_theme$variants4 = theme.variants[ownerState.variant]) == null || (_theme$variants4 = _theme$variants4[ownerState.color]) == null ? void 0 : _theme$variants4.color
  }, ownerState.disabled && {
    color: (_theme$variants5 = theme.variants[`${ownerState.variant}Disabled`]) == null || (_theme$variants5 = _theme$variants5[ownerState.color]) == null ? void 0 : _theme$variants5.color
  });
});
...
const StyledInputEndDecorator = (0, _styles.styled)('div')(({
  ...
  var _theme$variants6, _theme$variants7;
  return (0, _extends2.default)({
    ...
    color: (_theme$variants6 = theme.variants[ownerState.variant]) == null || (_theme$variants6 = _theme$variants6[ownerState.color]) == null ? void 0 : _theme$variants6.color,
    cursor: 'initial'
  }, ownerState.disabled && {
    color: (_theme$variants7 = theme.variants[`${ownerState.variant}Disabled`]) == null || (_theme$variants7 = _theme$variants7[ownerState.color]) == null ? void 0 : _theme$variants7.color
  });
});
