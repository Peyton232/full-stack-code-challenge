...
const StyledButtonGroup = (0, _styled.default)('div')(({
  ...
  return [(0, _extends2.default)({
    ...
    // prevent inheritance from above to children
    ...
    [`& .${_buttonClasses.default.root}, & .${_iconButtonClasses.default.root}`]: (0, _extends2.default)({
      ...
      '&:disabled': {
        '--ButtonGroup-separatorColor': (_theme$vars$palette3 = theme.vars.palette[ownerState.color]) == null ? void 0 : _theme$vars$palette3.outlinedDisabledBorder
      }
    }, ownerState.variant === 'outlined' && ownerState.color !== 'context' && {
      '&:hover': {
        '--ButtonGroup-separatorColor': (_theme$vars$palette4 = theme.vars.palette[ownerState.color]) == null ? void 0 : _theme$vars$palette4.outlinedHoverBorder
      }
    }, {
