...
const ChipRoot = (0, _styled.default)('div', {
  ...
  return [(0, _extends2.default)({
    ...
    [`&.${_chipClasses.default.disabled}`]: {
      color: (_theme$variants = theme.variants[`${ownerState.variant}Disabled`]) == null || (_theme$variants = _theme$variants[ownerState.color]) == null ? void 0 : _theme$variants.color
    }
  }), ...(!ownerState.clickable ? [(_theme$variants2 = theme.variants[ownerState.variant]) == null ? void 0 : _theme$variants2[ownerState.color], {
...
const ChipAction = (0, _styled.default)('button', {
  ...
  return [{
    ...
    [`&.${_chipClasses.default.disabled}`]: (_theme$variants8 = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _theme$variants8[ownerState.color]
  }];
});
