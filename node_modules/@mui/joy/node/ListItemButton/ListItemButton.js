...
const StyledListItemButton = (0, _styles.styled)('div')(({
  ...
  return [(0, _extends2.default)({}, ownerState.selected && {
    ...
    '--ListItemDecorator-color': (_theme$variants = theme.variants) == null || (_theme$variants = _theme$variants[`${ownerState.variant}Disabled`]) == null || (_theme$variants = _theme$variants[ownerState.color]) == null ? void 0 : _theme$variants.color
  }, {
  ...
  }), (0, _extends2.default)({}, (_theme$variants2 = theme.variants[ownerState.variant]) == null ? void 0 : _theme$variants2[ownerState.color], !ownerState.selected && {
    ...
    [`&.${_listItemButtonClasses.default.disabled}`]: (_theme$variants5 = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _theme$variants5[ownerState.color]
  }];
});
