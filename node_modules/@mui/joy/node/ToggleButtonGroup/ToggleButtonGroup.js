...
const ToggleButtonGroupRoot = (0, _styled.default)(_ButtonGroup.StyledButtonGroup, {
  ...
  return {
    '& [aria-pressed="true"], & [aria-pressed="true"]:not([data-first-child]):not([data-last-child])': (0, _extends2.default)({}, ownerState.color !== 'context' && (0, _extends2.default)({
      backgroundColor: (_theme$vars$palette = theme.vars.palette) == null || (_theme$vars$palette = _theme$vars$palette[ownerState.color]) == null ? void 0 : _theme$vars$palette[`${ownerState.variant}ActiveBg`]
    }, ownerState.variant === 'outlined' && {
      borderColor: (_theme$vars$palette2 = theme.vars.palette) == null || (_theme$vars$palette2 = _theme$vars$palette2[ownerState.color]) == null ? void 0 : _theme$vars$palette2[`${ownerState.variant}HoverBorder`]
    }, {
      '&:hover': {
        backgroundColor: (_theme$vars$palette3 = theme.vars.palette) == null || (_theme$vars$palette3 = _theme$vars$palette3[ownerState.color]) == null ? void 0 : _theme$vars$palette3[`${ownerState.variant}ActiveBg`]
      },
      '&:not(:disabled)': {
        zIndex: 2
      }
