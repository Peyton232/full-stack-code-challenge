...
export const StyledAutocompleteOption = styled(StyledListItemButton)(({
  ...
  var _theme$variants, _theme$variants$soft, _theme$variants$soft2, _theme$variants2;
  return {
    ...
    '&[aria-selected="true"]': {
      color: (_theme$variants$soft = theme.variants.soft) == null || (_theme$variants$soft = _theme$variants$soft[ownerState.color === 'context' ? 'context' : 'primary']) == null ? void 0 : _theme$variants$soft.color,
      backgroundColor: (_theme$variants$soft2 = theme.variants.soft) == null || (_theme$variants$soft2 = _theme$variants$soft2[ownerState.color === 'context' ? 'context' : 'primary']) == null ? void 0 : _theme$variants$soft2.backgroundColor,
    ...
    [`&.${autocompleteOptionClasses.focused}:not([aria-selected="true"]):not(:hover)`]: {
      ...
      backgroundColor: (_theme$variants2 = theme.variants[`${ownerState.variant}Hover`]) == null || (_theme$variants2 = _theme$variants2[ownerState.color]) == null ? void 0 : _theme$variants2.backgroundColor
    }
  };
});
